...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, uz.itcenter.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, uz.itcenter.repository.UserRepository.USERS_BY_EMAIL_CACHE);
