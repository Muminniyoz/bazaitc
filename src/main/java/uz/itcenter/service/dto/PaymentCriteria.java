...
/**
 * Criteria class for the {@link uz.itcenter.domain.Payment} entity. This class is used
 * in {@link uz.itcenter.web.rest.PaymentResource} to receive all the possible filtering options from
...
public class PaymentCriteria implements Serializable, Criteria {
    ...
    private LongFilter confirmedById;
    ...
    public PaymentCriteria(PaymentCriteria other) {
        ...
        this.confirmedById = other.confirmedById == null ? null : other.confirmedById.copy();
    ...
    public LongFilter getConfirmedById() {
        return confirmedById;
    }

    public void setConfirmedById(LongFilter confirmedById) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(confirmedById, that.confirmedById) &&
    ...
    public String toString() {
        return "PaymentCriteria{" +
                ...
                (confirmedById != null ? "confirmedById=" + confirmedById + ", " : "") +
