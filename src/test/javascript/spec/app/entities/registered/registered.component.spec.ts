...
import { RegisteredComponent } from 'app/entities/registered/registered.component';
...
describe('Component Tests', () => {
  describe('Registered Management Component', () => {
    let comp: RegisteredComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RegisteredComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.registereds && comp.registereds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
