...
import { CoursePlanComponent } from 'app/entities/course-plan/course-plan.component';
...
describe('Component Tests', () => {
  describe('CoursePlan Management Component', () => {
    let comp: CoursePlanComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CoursePlanComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.coursePlans && comp.coursePlans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
