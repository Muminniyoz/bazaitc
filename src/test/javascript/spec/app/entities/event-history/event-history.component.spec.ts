...
import { EventHistoryComponent } from 'app/entities/event-history/event-history.component';
...
describe('Component Tests', () => {
  describe('EventHistory Management Component', () => {
    let comp: EventHistoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EventHistoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.eventHistories && comp.eventHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
