...
import { SystemConfigComponent } from 'app/entities/system-config/system-config.component';
...
describe('Component Tests', () => {
  describe('SystemConfig Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.systemConfigs && comp.systemConfigs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
