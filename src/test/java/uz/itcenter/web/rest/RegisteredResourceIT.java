...
import uz.itcenter.domain.Registered;
import uz.itcenter.domain.User;
import uz.itcenter.domain.Course;
import uz.itcenter.repository.RegisteredRepository;
import uz.itcenter.service.RegisteredService;
import uz.itcenter.service.dto.RegisteredDTO;
import uz.itcenter.service.mapper.RegisteredMapper;
import uz.itcenter.service.dto.RegisteredCriteria;
import uz.itcenter.service.RegisteredQueryService;
...
public class RegisteredResourceIT {
    ...
    public void createRegistered() throws Exception {
        ...
        assertThat(testRegistered.getInfo()).isEqualTo(DEFAULT_INFO);
    }
    ...
    @Test
    @Transactional
    public void getAllRegisteredsByInfoIsEqualToSomething() throws Exception {
        // Initialize the database
        registeredRepository.saveAndFlush(registered);

        // Get all the registeredList where info equals to DEFAULT_INFO
        defaultRegisteredShouldBeFound("info.equals=" + DEFAULT_INFO);

        // Get all the registeredList where info equals to UPDATED_INFO
        defaultRegisteredShouldNotBeFound("info.equals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllRegisteredsByInfoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        registeredRepository.saveAndFlush(registered);

        // Get all the registeredList where info not equals to DEFAULT_INFO
        defaultRegisteredShouldNotBeFound("info.notEquals=" + DEFAULT_INFO);

        // Get all the registeredList where info not equals to UPDATED_INFO
        defaultRegisteredShouldBeFound("info.notEquals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllRegisteredsByInfoIsInShouldWork() throws Exception {
        // Initialize the database
        registeredRepository.saveAndFlush(registered);

        // Get all the registeredList where info in DEFAULT_INFO or UPDATED_INFO
        defaultRegisteredShouldBeFound("info.in=" + DEFAULT_INFO + "," + UPDATED_INFO);

        // Get all the registeredList where info equals to UPDATED_INFO
        defaultRegisteredShouldNotBeFound("info.in=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllRegisteredsByInfoIsNullOrNotNull() throws Exception {
        // Initialize the database
        registeredRepository.saveAndFlush(registered);

        // Get all the registeredList where info is not null
        defaultRegisteredShouldBeFound("info.specified=true");

        // Get all the registeredList where info is null
        defaultRegisteredShouldNotBeFound("info.specified=false");
    }
                @Test
    @Transactional
    public void getAllRegisteredsByInfoContainsSomething() throws Exception {
        // Initialize the database
        registeredRepository.saveAndFlush(registered);

        // Get all the registeredList where info contains DEFAULT_INFO
        defaultRegisteredShouldBeFound("info.contains=" + DEFAULT_INFO);

        // Get all the registeredList where info contains UPDATED_INFO
        defaultRegisteredShouldNotBeFound("info.contains=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllRegisteredsByInfoNotContainsSomething() throws Exception {
        // Initialize the database
        registeredRepository.saveAndFlush(registered);

        // Get all the registeredList where info does not contain DEFAULT_INFO
        defaultRegisteredShouldNotBeFound("info.doesNotContain=" + DEFAULT_INFO);

        // Get all the registeredList where info does not contain UPDATED_INFO
        defaultRegisteredShouldBeFound("info.doesNotContain=" + UPDATED_INFO);
    }
    ...
    public void updateRegistered() throws Exception {
        ...
        assertThat(testRegistered.getInfo()).isEqualTo(UPDATED_INFO);
    }
