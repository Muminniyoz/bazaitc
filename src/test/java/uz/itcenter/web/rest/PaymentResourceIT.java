...
import uz.itcenter.domain.PaymentMethod;
import uz.itcenter.repository.PaymentRepository;
import uz.itcenter.service.PaymentService;
import uz.itcenter.service.dto.PaymentDTO;
import uz.itcenter.service.mapper.PaymentMapper;
import uz.itcenter.service.dto.PaymentCriteria;
import uz.itcenter.service.PaymentQueryService;
...
import static uz.itcenter.web.rest.TestUtil.sameInstant;
...
public class PaymentResourceIT {
    ...
    @Test
    @Transactional
    public void getAllPaymentsByMonthIsEqualToSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    public void getAllPaymentsByMonthIsNotEqualToSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    public void getAllPaymentsByMonthIsInShouldWork() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    public void getAllPaymentsByMonthIsNullOrNotNull() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
    ...
    @Test
    @Transactional
    public void getAllPaymentsByInfoIsEqualToSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);

        // Get all the paymentList where info equals to DEFAULT_INFO
        defaultPaymentShouldBeFound("info.equals=" + DEFAULT_INFO);

        // Get all the paymentList where info equals to UPDATED_INFO
        defaultPaymentShouldNotBeFound("info.equals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllPaymentsByInfoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);

        // Get all the paymentList where info not equals to DEFAULT_INFO
        defaultPaymentShouldNotBeFound("info.notEquals=" + DEFAULT_INFO);

        // Get all the paymentList where info not equals to UPDATED_INFO
        defaultPaymentShouldBeFound("info.notEquals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllPaymentsByInfoIsInShouldWork() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);

        // Get all the paymentList where info in DEFAULT_INFO or UPDATED_INFO
        defaultPaymentShouldBeFound("info.in=" + DEFAULT_INFO + "," + UPDATED_INFO);

        // Get all the paymentList where info equals to UPDATED_INFO
        defaultPaymentShouldNotBeFound("info.in=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllPaymentsByInfoIsNullOrNotNull() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);

        // Get all the paymentList where info is not null
        defaultPaymentShouldBeFound("info.specified=true");

        // Get all the paymentList where info is null
        defaultPaymentShouldNotBeFound("info.specified=false");
    }
                @Test
    @Transactional
    public void getAllPaymentsByInfoContainsSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);

        // Get all the paymentList where info contains DEFAULT_INFO
        defaultPaymentShouldBeFound("info.contains=" + DEFAULT_INFO);

        // Get all the paymentList where info contains UPDATED_INFO
        defaultPaymentShouldNotBeFound("info.contains=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllPaymentsByInfoNotContainsSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);

        // Get all the paymentList where info does not contain DEFAULT_INFO
        defaultPaymentShouldNotBeFound("info.doesNotContain=" + DEFAULT_INFO);

        // Get all the paymentList where info does not contain UPDATED_INFO
        defaultPaymentShouldBeFound("info.doesNotContain=" + UPDATED_INFO);
    }
    ...
    @Test
    @Transactional
    public void getAllPaymentsByConfirmedByIsEqualToSomething() throws Exception {
        // Initialize the database
        paymentRepository.saveAndFlush(payment);
        User confirmedBy = UserResourceIT.createEntity(em);
        em.persist(confirmedBy);
        em.flush();
        payment.setConfirmedBy(confirmedBy);
        paymentRepository.saveAndFlush(payment);
        Long confirmedById = confirmedBy.getId();

        // Get all the paymentList where confirmedBy equals to confirmedById
        defaultPaymentShouldBeFound("confirmedById.equals=" + confirmedById);

        // Get all the paymentList where confirmedBy equals to confirmedById + 1
        defaultPaymentShouldNotBeFound("confirmedById.equals=" + (confirmedById + 1));
    }
