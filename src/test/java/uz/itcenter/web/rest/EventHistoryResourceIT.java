...
import uz.itcenter.domain.enumeration.EventType;
/**
...
public class EventHistoryResourceIT {
    ...
    public void createEventHistory() throws Exception {
        ...
        assertThat(testEventHistory.getIdNumber()).isEqualTo(DEFAULT_ID_NUMBER);
    ...
    @Test
    @Transactional
    public void getAllEventHistoriesByIdNumberIsEqualToSomething() throws Exception {
        // Initialize the database
        eventHistoryRepository.saveAndFlush(eventHistory);

        // Get all the eventHistoryList where idNumber equals to DEFAULT_ID_NUMBER
        defaultEventHistoryShouldBeFound("idNumber.equals=" + DEFAULT_ID_NUMBER);

        // Get all the eventHistoryList where idNumber equals to UPDATED_ID_NUMBER
        defaultEventHistoryShouldNotBeFound("idNumber.equals=" + UPDATED_ID_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEventHistoriesByIdNumberIsNotEqualToSomething() throws Exception {
        // Initialize the database
        eventHistoryRepository.saveAndFlush(eventHistory);

        // Get all the eventHistoryList where idNumber not equals to DEFAULT_ID_NUMBER
        defaultEventHistoryShouldNotBeFound("idNumber.notEquals=" + DEFAULT_ID_NUMBER);

        // Get all the eventHistoryList where idNumber not equals to UPDATED_ID_NUMBER
        defaultEventHistoryShouldBeFound("idNumber.notEquals=" + UPDATED_ID_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEventHistoriesByIdNumberIsInShouldWork() throws Exception {
        // Initialize the database
        eventHistoryRepository.saveAndFlush(eventHistory);

        // Get all the eventHistoryList where idNumber in DEFAULT_ID_NUMBER or UPDATED_ID_NUMBER
        defaultEventHistoryShouldBeFound("idNumber.in=" + DEFAULT_ID_NUMBER + "," + UPDATED_ID_NUMBER);

        // Get all the eventHistoryList where idNumber equals to UPDATED_ID_NUMBER
        defaultEventHistoryShouldNotBeFound("idNumber.in=" + UPDATED_ID_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEventHistoriesByIdNumberIsNullOrNotNull() throws Exception {
        // Initialize the database
        eventHistoryRepository.saveAndFlush(eventHistory);

        // Get all the eventHistoryList where idNumber is not null
        defaultEventHistoryShouldBeFound("idNumber.specified=true");

        // Get all the eventHistoryList where idNumber is null
        defaultEventHistoryShouldNotBeFound("idNumber.specified=false");
    }
                @Test
    @Transactional
    public void getAllEventHistoriesByIdNumberContainsSomething() throws Exception {
        // Initialize the database
        eventHistoryRepository.saveAndFlush(eventHistory);

        // Get all the eventHistoryList where idNumber contains DEFAULT_ID_NUMBER
        defaultEventHistoryShouldBeFound("idNumber.contains=" + DEFAULT_ID_NUMBER);

        // Get all the eventHistoryList where idNumber contains UPDATED_ID_NUMBER
        defaultEventHistoryShouldNotBeFound("idNumber.contains=" + UPDATED_ID_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEventHistoriesByIdNumberNotContainsSomething() throws Exception {
        // Initialize the database
        eventHistoryRepository.saveAndFlush(eventHistory);

        // Get all the eventHistoryList where idNumber does not contain DEFAULT_ID_NUMBER
        defaultEventHistoryShouldNotBeFound("idNumber.doesNotContain=" + DEFAULT_ID_NUMBER);

        // Get all the eventHistoryList where idNumber does not contain UPDATED_ID_NUMBER
        defaultEventHistoryShouldBeFound("idNumber.doesNotContain=" + UPDATED_ID_NUMBER);
    }
    ...
    public void updateEventHistory() throws Exception {
        ...
        assertThat(testEventHistory.getIdNumber()).isEqualTo(UPDATED_ID_NUMBER);
