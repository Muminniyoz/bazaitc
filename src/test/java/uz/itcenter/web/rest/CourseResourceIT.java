...
public class CourseResourceIT {
    ...
    public void createCourse() throws Exception {
        ...
        assertThat(testCourse.getInfo()).isEqualTo(DEFAULT_INFO);
    }
    ...
    @Test
    @Transactional
    public void getAllCoursesByInfoIsEqualToSomething() throws Exception {
        // Initialize the database
        courseRepository.saveAndFlush(course);

        // Get all the courseList where info equals to DEFAULT_INFO
        defaultCourseShouldBeFound("info.equals=" + DEFAULT_INFO);

        // Get all the courseList where info equals to UPDATED_INFO
        defaultCourseShouldNotBeFound("info.equals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllCoursesByInfoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        courseRepository.saveAndFlush(course);

        // Get all the courseList where info not equals to DEFAULT_INFO
        defaultCourseShouldNotBeFound("info.notEquals=" + DEFAULT_INFO);

        // Get all the courseList where info not equals to UPDATED_INFO
        defaultCourseShouldBeFound("info.notEquals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllCoursesByInfoIsInShouldWork() throws Exception {
        // Initialize the database
        courseRepository.saveAndFlush(course);

        // Get all the courseList where info in DEFAULT_INFO or UPDATED_INFO
        defaultCourseShouldBeFound("info.in=" + DEFAULT_INFO + "," + UPDATED_INFO);

        // Get all the courseList where info equals to UPDATED_INFO
        defaultCourseShouldNotBeFound("info.in=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllCoursesByInfoIsNullOrNotNull() throws Exception {
        // Initialize the database
        courseRepository.saveAndFlush(course);

        // Get all the courseList where info is not null
        defaultCourseShouldBeFound("info.specified=true");

        // Get all the courseList where info is null
        defaultCourseShouldNotBeFound("info.specified=false");
    }
                @Test
    @Transactional
    public void getAllCoursesByInfoContainsSomething() throws Exception {
        // Initialize the database
        courseRepository.saveAndFlush(course);

        // Get all the courseList where info contains DEFAULT_INFO
        defaultCourseShouldBeFound("info.contains=" + DEFAULT_INFO);

        // Get all the courseList where info contains UPDATED_INFO
        defaultCourseShouldNotBeFound("info.contains=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllCoursesByInfoNotContainsSomething() throws Exception {
        // Initialize the database
        courseRepository.saveAndFlush(course);

        // Get all the courseList where info does not contain DEFAULT_INFO
        defaultCourseShouldNotBeFound("info.doesNotContain=" + DEFAULT_INFO);

        // Get all the courseList where info does not contain UPDATED_INFO
        defaultCourseShouldBeFound("info.doesNotContain=" + UPDATED_INFO);
    }
    ...
    public void updateCourse() throws Exception {
        ...
        assertThat(testCourse.getInfo()).isEqualTo(UPDATED_INFO);
    }
