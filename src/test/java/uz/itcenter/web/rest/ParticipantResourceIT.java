...
import uz.itcenter.repository.ParticipantRepository;
import uz.itcenter.service.ParticipantService;
import uz.itcenter.service.dto.ParticipantDTO;
import uz.itcenter.service.mapper.ParticipantMapper;
import uz.itcenter.service.dto.ParticipantCriteria;
import uz.itcenter.service.ParticipantQueryService;
...
public class ParticipantResourceIT {
    ...
    public void createParticipant() throws Exception {
        ...
        assertThat(testParticipant.getInfo()).isEqualTo(DEFAULT_INFO);
    }
    ...
    @Test
    @Transactional
    public void getAllParticipantsByInfoIsEqualToSomething() throws Exception {
        // Initialize the database
        participantRepository.saveAndFlush(participant);

        // Get all the participantList where info equals to DEFAULT_INFO
        defaultParticipantShouldBeFound("info.equals=" + DEFAULT_INFO);

        // Get all the participantList where info equals to UPDATED_INFO
        defaultParticipantShouldNotBeFound("info.equals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllParticipantsByInfoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        participantRepository.saveAndFlush(participant);

        // Get all the participantList where info not equals to DEFAULT_INFO
        defaultParticipantShouldNotBeFound("info.notEquals=" + DEFAULT_INFO);

        // Get all the participantList where info not equals to UPDATED_INFO
        defaultParticipantShouldBeFound("info.notEquals=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllParticipantsByInfoIsInShouldWork() throws Exception {
        // Initialize the database
        participantRepository.saveAndFlush(participant);

        // Get all the participantList where info in DEFAULT_INFO or UPDATED_INFO
        defaultParticipantShouldBeFound("info.in=" + DEFAULT_INFO + "," + UPDATED_INFO);

        // Get all the participantList where info equals to UPDATED_INFO
        defaultParticipantShouldNotBeFound("info.in=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllParticipantsByInfoIsNullOrNotNull() throws Exception {
        // Initialize the database
        participantRepository.saveAndFlush(participant);

        // Get all the participantList where info is not null
        defaultParticipantShouldBeFound("info.specified=true");

        // Get all the participantList where info is null
        defaultParticipantShouldNotBeFound("info.specified=false");
    }
                @Test
    @Transactional
    public void getAllParticipantsByInfoContainsSomething() throws Exception {
        // Initialize the database
        participantRepository.saveAndFlush(participant);

        // Get all the participantList where info contains DEFAULT_INFO
        defaultParticipantShouldBeFound("info.contains=" + DEFAULT_INFO);

        // Get all the participantList where info contains UPDATED_INFO
        defaultParticipantShouldNotBeFound("info.contains=" + UPDATED_INFO);
    }

    @Test
    @Transactional
    public void getAllParticipantsByInfoNotContainsSomething() throws Exception {
        // Initialize the database
        participantRepository.saveAndFlush(participant);

        // Get all the participantList where info does not contain DEFAULT_INFO
        defaultParticipantShouldNotBeFound("info.doesNotContain=" + DEFAULT_INFO);

        // Get all the participantList where info does not contain UPDATED_INFO
        defaultParticipantShouldBeFound("info.doesNotContain=" + UPDATED_INFO);
    }
    ...
    public void updateParticipant() throws Exception {
        ...
        assertThat(testParticipant.getInfo()).isEqualTo(UPDATED_INFO);
    }
